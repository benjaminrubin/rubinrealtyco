...
$(document).ready(function() {
    ...
    $("#entry\\.95296602").change(function() {
        var name = document.forms["contactform"]["entry.95296602"].value;
        if (name == "") {
    ...
    $("#entry\\.1345085109").change(function() {
        var email = document.forms["contactform"]["entry.1345085109"].value;
        if (email == "") {
    ...
    $("#entry\\.2051240585").change(function() {
        var phone = document.forms["contactform"]["entry.2051240585"].value;
    ...
    $("#entry\\.103209598").change(function() {
        var city = document.forms["contactform"]["entry.103209598"].value;
        if (hasNumber(city)) {
    ...
    $("#entry\\.796581087").change(function() {
        var country = document.forms["contactform"]["entry.796581087"].value;
        if (country == "") {
    ...
    $("#entry\\.1208074259").change(function() {
        var start = new Date(document.forms["contactform"]["entry.1208074259"].value);
        var now = new Date();
        if (start < now) {
    ...
    $("#entry\\.596499932").change(function() {
        var end = new Date(document.forms["contactform"]["entry.596499932"].value);
        var now = new Date();
        if (end < startDate) {
